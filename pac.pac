...
function _check_patterns(i,o,c,m){
  return!(!i.hasOwnProperty(o)||
          !_check_regex_list(i[o],c.slice(m+o.length)))||!!_check_regex_list(i.any,c.slice(m))
}
...
var _http_map={
  white:{
    any:[],"bangumi.bilibili.com":[/^\/index\/ding\-count\.json$/i]
  },
  proxy:{
    any:[/^[^\/]*\.cupid\.iqiyi\.com\//i,
         /^[^\/]*\.video\.qq\.com\//i,
         /^[^\/]*\.video\.qq\.com\//i,
         /^[^\/]*\.dpool\.sina\.com\.cn\//i,
         /^[^\/]*\.letv\.com\//i,
    ...
    "122.72.82.31":[/^\//i],"211.151.158.155":[/^\//i],
    "info.zb.qq.com":[/^\//i],
...
,_proxy_str="PROXY pi.qiyisoft.win:3128; DIRECT;";
